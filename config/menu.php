...
//        ->url('http://www.google.com', 'Google')
        ...
        #adminlte_menu
        ->addIfCan('migrate-users',Link::toUrl('/users-migration', '<i class="fa fa-link"></i><span>Users migration</span>'))
        ->add(Link::toUrl('proves', '<i class="fa fa-link"></i><span>Proves</span>'))
        ->add(Link::toUrl('tokens', '<i class="fa fa-link"></i><span>Tokens</span>'))
        ->addIfCan('see-manage-users-view',Link::toUrl('/users', '<i class="fa fa-user"></i><span>Users</span>'))
        ->addIfCan('see-users-dashboard',Link::toUrl('/users/dashboard', '<i class="fa fa-link"></i><span>Users dashboard</span>'))
        ->addIfCan('see-users-tracking',Link::toUrl('/users/tracking', '<i class="fa fa-link"></i><span>Users tracking</span>'))
        ->addIfCan('see-google-apps-users',Link::toUrl('/users/google', '<i class="fa fa-link"></i><span>Google apps Users</span>'))
