<template>
  <div class="box box-primary" :id="'user-' + rowData.id + '-detail-row'">
    ...
    <div class="box-body">
      ...
      <p class="text-muted">
        <editable resource="user" :id="rowData.id" :edit="editing" :content="rowData.name" name="name" :api-url="apiUri" after-save-event="reload-users-list"></editable>
      </p>
      ...
      <p class="text-muted">
        <editable resource="user" :id="rowData.id" :edit="editing" :content="rowData.email" name="email" :api-url="apiUri" after-save-event="reload-users-list"></editable>
      </p>
