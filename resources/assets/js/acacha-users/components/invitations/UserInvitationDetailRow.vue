<template>
  <div class="box box-primary" :id="'user-invitation-' + rowData.id + '-detail-row'">
    ...
    <div class="box-body">
      ...
      <p class="text-muted">
        <editable resource="user-invitation" :id="rowData.id" :edit="editing" :content="rowData.email" name="email" :api-url="apiUri" after-save-event="reload-user-invitations-list"></editable>
      </p>
      ...
      <p class="text-muted">
        ...
        <editable resource="user-invitation" :id="rowData.id" :edit="editing" :content="rowData.state" name="state" :api-url="apiUri" after-save-event="reload-user-invitations-list"></editable>
      </p>
...
<script>
  ...
  export default {
    computed: {
      apiUri: function () {
        return this.store.apiUri + '-invitations'
      }
    },
    mixins: [
      DetailRow
